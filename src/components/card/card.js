    ...
    render() {
        ...
        this.el.innerHTML = `
            <div class="card__image">
                <img src = "https://covers.openlibrary.org/b/id/${this.cardState.cover_i}-M.jpg" alt="cover" />
            </div>
            <div class="card__info">
                ...
                <div class="card__author">
                    ${this.cardState.author_name ? this.cardState.author_name[0] : 'Автор не указан'}
                </div>
